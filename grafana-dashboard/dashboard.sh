...
kubectl create configmap datasource-config -n $tenant --from-file=$working_dir/dashboard_files/datasources.yaml
kubectl create configmap dashboard-config -n $tenant --from-file=$working_dir/dashboard_files/dashboards.yaml
kubectl create configmap dashboard-json -n $tenant --from-file=$working_dir/dashboard_files/jmeterTemplate.json
